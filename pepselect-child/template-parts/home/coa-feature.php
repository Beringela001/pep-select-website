		...
		<div class="pepselect-home__archive-panel">
			<div class="pepselect-home__archive-copy">
				...
				<h2 id="pepselect-archive-title">
					<span><?php esc_html_e( 'Match the vial.', 'pepselect-child' ); ?></span>
					<em><?php esc_html_e( 'Match the batch.', 'pepselect-child' ); ?></em>
				</h2>
				<p><?php esc_html_e( 'Search by compound, follow current and historical records, and open the full batch page for the details available on file.', 'pepselect-child' ); ?></p>

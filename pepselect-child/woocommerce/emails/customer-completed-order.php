...
<head>
	...
	<style type="text/css">
		...
		@media only screen and (max-width:520px){
			...
			.pep-email-status-step{box-sizing:border-box!important;display:block!important;padding:7px 0!important;width:100%!important}
			.pep-email-status-step+.pep-email-status-step{border-left:0!important;border-top:1px solid <?php echo esc_attr( $pep['border'] ); ?>!important}
			...
			<table border="0" cellpadding="0" cellspacing="0" class="pep-email-card" role="presentation" width="100%" style="background-color:<?php echo esc_attr( $pep['white'] ); ?>;border-radius:18px;box-shadow:0 18px 46px rgba(0,42,83,.14);max-width:680px;overflow:hidden;width:100%;">
				...
				<tr><td class="pep-email-main" style="padding:0 44px 34px;">
					...
					<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="background-color:#F8FAFC;border:1px solid <?php echo esc_attr( $pep['border'] ); ?>;border-radius:8px;margin:0 0 22px;overflow:hidden;"><tr>
						<td class="pep-email-status-step" style="padding:15px 12px;width:25%;" valign="middle" width="25%"><table border="0" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="color:#1E9467;font-family:Arial,Helvetica,sans-serif;font-size:17px;font-weight:700;line-height:18px;padding-right:7px;" width="20">&#10003;</td><td style="color:<?php echo esc_attr( $pep['ink'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;font-weight:700;line-height:1.35;"><?php esc_html_e( 'Order received', 'pepselect-child' ); ?></td></tr></table></td>
						<td class="pep-email-status-step" style="border-left:1px solid <?php echo esc_attr( $pep['border'] ); ?>;padding:15px 12px;width:25%;" valign="middle" width="25%"><table border="0" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="color:#1E9467;font-family:Arial,Helvetica,sans-serif;font-size:17px;font-weight:700;line-height:18px;padding-right:7px;" width="20">&#10003;</td><td style="color:<?php echo esc_attr( $pep['ink'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;font-weight:700;line-height:1.35;"><?php esc_html_e( 'Payment confirmed', 'pepselect-child' ); ?></td></tr></table></td>
						<td class="pep-email-status-step" style="border-left:1px solid <?php echo esc_attr( $pep['border'] ); ?>;padding:15px 12px;width:25%;" valign="middle" width="25%"><table border="0" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="color:#1E9467;font-family:Arial,Helvetica,sans-serif;font-size:17px;font-weight:700;line-height:18px;padding-right:7px;" width="20">&#10003;</td><td style="color:<?php echo esc_attr( $pep['ink'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;font-weight:700;line-height:1.35;"><?php esc_html_e( 'Processed', 'pepselect-child' ); ?></td></tr></table></td>
						<td class="pep-email-status-step" style="border-left:1px solid <?php echo esc_attr( $pep['border'] ); ?>;padding:15px 12px;width:25%;" valign="middle" width="25%"><table border="0" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="color:<?php echo esc_attr( $pep['cyan'] ); ?>;font-family:Arial,Helvetica,sans-serif;font-size:19px;line-height:18px;padding-right:7px;" width="20">&#9675;</td><td style="color:<?php echo esc_attr( $pep['ink'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;font-weight:700;line-height:1.35;"><?php esc_html_e( 'Shipped', 'pepselect-child' ); ?></td></tr></table></td>
					</tr></table>

			...
			<table border="0" cellpadding="0" cellspacing="0" class="pep-email-card" role="presentation" width="100%" style="background-color:<?php echo esc_attr( $pep['white'] ); ?>;border-radius:18px;box-shadow:0 18px 46px rgba(0,42,83,.14);max-width:680px;overflow:hidden;width:100%;">
				...
				<tr><td class="pep-email-main" style="padding:0 44px 34px;">
					...
					<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="background-color:#F8FAFC;border:1px solid <?php echo esc_attr( $pep['border'] ); ?>;border-radius:8px;margin:0 0 22px;overflow:hidden;"><tr><td style="padding:18px 18px 16px;"><table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%"><tr>
						<td class="pep-email-status-step" style="width:25%;" valign="top" width="25%"><table border="0" cellpadding="0" cellspacing="0" class="pep-email-status-icon-table" role="presentation" width="100%"><tr><td style="color:#1E9467;font-family:Arial,Helvetica,sans-serif;font-size:17px;font-weight:700;line-height:17px;width:20px;" width="20">&#10003;</td><td class="pep-email-status-line" style="border-top:2px solid #9FD5C2;font-size:0;line-height:0;">&nbsp;</td></tr></table><p class="pep-email-status-label" style="color:<?php echo esc_attr( $pep['ink'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;font-weight:700;line-height:1.35;margin:7px 0 0;"><?php esc_html_e( 'Order received', 'pepselect-child' ); ?></p></td>
						<td class="pep-email-status-step" style="width:25%;" valign="top" width="25%"><table border="0" cellpadding="0" cellspacing="0" class="pep-email-status-icon-table" role="presentation" width="100%"><tr><td style="color:#1E9467;font-family:Arial,Helvetica,sans-serif;font-size:17px;font-weight:700;line-height:17px;width:20px;" width="20">&#10003;</td><td class="pep-email-status-line" style="border-top:2px solid #9FD5C2;font-size:0;line-height:0;">&nbsp;</td></tr></table><p class="pep-email-status-label" style="color:<?php echo esc_attr( $pep['ink'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;font-weight:700;line-height:1.35;margin:7px 0 0;"><?php esc_html_e( 'Payment confirmed', 'pepselect-child' ); ?></p></td>
						<td class="pep-email-status-step" style="width:25%;" valign="top" width="25%"><table border="0" cellpadding="0" cellspacing="0" class="pep-email-status-icon-table" role="presentation" width="100%"><tr><td style="color:#1E9467;font-family:Arial,Helvetica,sans-serif;font-size:17px;font-weight:700;line-height:17px;width:20px;" width="20">&#10003;</td><td class="pep-email-status-line" style="border-top:2px solid #9FD5C2;font-size:0;line-height:0;">&nbsp;</td></tr></table><p class="pep-email-status-label" style="color:<?php echo esc_attr( $pep['ink'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;font-weight:700;line-height:1.35;margin:7px 0 0;"><?php esc_html_e( 'Processed', 'pepselect-child' ); ?></p></td>
						<td class="pep-email-status-step" style="width:25%;" valign="top" width="25%"><table border="0" cellpadding="0" cellspacing="0" class="pep-email-status-icon-table" role="presentation" width="20"><tr><td style="color:<?php echo esc_attr( $pep['cyan'] ); ?>;font-family:Arial,Helvetica,sans-serif;font-size:19px;line-height:17px;width:20px;" width="20">&#9675;</td></tr></table><p class="pep-email-status-label" style="color:<?php echo esc_attr( $pep['ink'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;font-weight:700;line-height:1.35;margin:7px 0 0;"><?php esc_html_e( 'Shipped', 'pepselect-child' ); ?></p></td>

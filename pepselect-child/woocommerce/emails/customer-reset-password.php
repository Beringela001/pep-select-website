...
$pep_note_html          = '<p style="margin:0 0 12px;">' . esc_html__( 'If you did not request this, you can ignore this email. Your password will not change unless the button above is used.', 'pepselect-child' ) . '</p><p style="margin:0;">' . esc_html__( 'Have a question? Reply to this email, and one of our team members will be in touch shortly.', 'pepselect-child' ) . '</p>';

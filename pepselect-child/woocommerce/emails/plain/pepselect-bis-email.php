...
echo "\n\n---\nPep Select\npepselect.com\n2090 Baker Rd, Ste 304 #A85\nKennesaw, GA 30144\nsupport@pepselect.com\n1 (833) 737-7528\n" . wp_strip_all_tags( function_exists( 'pepselect_child_company_ownership_line' ) ? pepselect_child_company_ownership_line() : __( '🇺🇸 American-owned and operated.', 'pepselect-child' ) ) . "\n" . wp_strip_all_tags( __( 'For laboratory research use only.', 'pepselect-child' ) ) . "\n";

...
$pep_button_url   = home_url( '/contact/' );
$pep_button_label = __( 'Contact our team', 'pepselect-child' );
$pep_note_html    = '<p style="margin:0;">' . esc_html__( 'Have a question about this refund? Include your order number when you contact us.', 'pepselect-child' ) . '</p>';

					...
					<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="border:1px solid <?php echo esc_attr( $pep['border'] ); ?>;border-radius:8px;margin:0 0 24px;overflow:hidden;"><tr><td class="pep-email-payment-card" style="padding:24px;">
						...
						<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%"><tr>
							<td style="padding-right:16px;" valign="top">
								<p style="color:#0D708E;font-family:<?php echo esc_attr( $pep['font_mono'] ); ?>;font-size:10px;font-weight:700;letter-spacing:1.3px;line-height:1.5;margin:0 0 8px;text-transform:uppercase;"><?php esc_html_e( 'Pay on this device', 'pepselect-child' ); ?></p>
								...
								<p style="color:<?php echo esc_attr( $pep['slate'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:12px;line-height:1.5;margin:0 0 10px;">This opens <strong>square.link</strong> in a new window.</p>
								<p style="color:<?php echo esc_attr( $pep['ink'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:12px;font-weight:700;line-height:1.5;margin:0 0 5px;"><?php esc_html_e( 'Or use the visible link', 'pepselect-child' ); ?></p>
								<p style="background-color:#F8FAFC;border:1px solid <?php echo esc_attr( $pep['border'] ); ?>;border-radius:6px;font-family:<?php echo esc_attr( $pep['font_mono'] ); ?>;font-size:12px;line-height:1.5;margin:0;padding:10px;word-break:break-all;"><a href="<?php echo esc_url( $pep_square_link ); ?>" style="color:#0D708E;text-decoration:underline;" target="_blank"><?php echo esc_html( $pep_square_link ); ?></a></p>
							</td>
							<td align="center" class="pep-email-qr" style="width:150px;" valign="top" width="150">
								<p style="color:#0D708E;font-family:<?php echo esc_attr( $pep['font_mono'] ); ?>;font-size:10px;font-weight:700;letter-spacing:1.3px;line-height:1.5;margin:0 0 8px;text-transform:uppercase;"><?php esc_html_e( 'Pay on your phone', 'pepselect-child' ); ?></p>
								...
								<p style="color:<?php echo esc_attr( $pep['slate'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:12px;line-height:1.45;margin:0;"><?php esc_html_e( 'Open your phone camera and scan this code.', 'pepselect-child' ); ?></p>
							</td>
						</tr></table>
						<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="background-color:#F3F6F8;border-radius:6px;margin-top:18px;"><tr><td style="color:<?php echo esc_attr( $pep['slate'] ); ?>;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:13px;line-height:1.55;padding:13px 15px;"><strong style="color:<?php echo esc_attr( $pep['ink'] ); ?>;">Bank statement:</strong> Your payment will appear as &ldquo;3BS Holdings LLC.&rdquo; After we confirm your payment, we&rsquo;ll email your updated order status.</td></tr></table>
					</td></tr></table>
					...
					<table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="background-color:#F8FAFC;border:1px solid <?php echo esc_attr( $pep['border'] ); ?>;border-radius:8px;margin:0 0 16px;overflow:hidden;">
						...
						<?php if ( '' !== $pep_research_value || '' !== $pep_points_value ) : ?>
							<tr><td colspan="2" style="border-top:1px solid <?php echo esc_attr( $pep['border'] ); ?>;padding:12px 20px;">
								<?php if ( '' !== $pep_research_value ) : ?><span style="border:1px solid <?php echo esc_attr( $pep['border'] ); ?>;border-radius:999px;color:<?php echo esc_attr( $pep['slate'] ); ?>;display:inline-block;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;line-height:1.4;margin:2px 6px 2px 0;padding:5px 10px;"><?php printf( esc_html__( 'Research purpose · %s', 'pepselect-child' ), esc_html( $pep_research_value ) ); ?></span><?php endif; ?>
								<?php if ( '' !== $pep_points_value ) : ?><span style="border:1px solid <?php echo esc_attr( $pep['border'] ); ?>;border-radius:999px;color:<?php echo esc_attr( $pep['slate'] ); ?>;display:inline-block;font-family:<?php echo esc_attr( $pep['font'] ); ?>;font-size:11px;line-height:1.4;margin:2px 6px 2px 0;padding:5px 10px;"><?php printf( esc_html__( '%s points earned', 'pepselect-child' ), esc_html( $pep_points_value ) ); ?></span><?php endif; ?>
							</td></tr>
						<?php endif; ?>
					</table>

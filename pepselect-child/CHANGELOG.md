...
**Live version: 0.20.0-beta.34** — installed and verified 2026-08-12 from the stylesheet loaded by the production checkout. Treat this line as a dated summary; verify the deployed `style.css` before answering what is live.

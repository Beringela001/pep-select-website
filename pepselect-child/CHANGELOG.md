...
**Live version: 0.20.0-beta.44** — installed and verified 2026-08-12 from the production side cart and WordPress theme replacement result. Treat this line as a dated summary; verify the deployed `style.css` before answering what is live.

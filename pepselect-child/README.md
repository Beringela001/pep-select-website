...
Pep Select is the lightweight presentation child theme for the controlled customer-facing rebuild. Version 0.21.0-beta.5 adds the staging-first SEO Milestone 3 catalog, structured-data, and internal-discovery corrections while preserving WooCommerce, COA, checkout, account, rewards, verification, and order behavior.

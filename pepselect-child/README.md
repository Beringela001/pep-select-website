...
Pep Select is the lightweight presentation child theme for the controlled customer-facing rebuild. Version 0.25.0-beta.15 adds the approved responsive payment-confirmed email with appreciative messaging, clear fulfillment expectations, dynamic WooCommerce order details, and the shared mobile-safe transactional email presentation. WooCommerce remains the source of truth for product images, item data, totals, addresses, accounts, shipping methods, and order status.

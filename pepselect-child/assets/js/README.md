...
Version 0.4.0-beta.3 retains `header.js` and `homepage.js`. Both scripts are dependency-free and component-scoped. `homepage.js` loads only for the authorized private homepage preview and controls the FAQ accordion's expanded state and keyboard navigation.

...
pepselect_shipping_assert( PepSelect_Shipping_Restrictions::address_is_allowed( 'PR', '', '00901' ), 'Puerto Rico country and ZIP should pass.' );
...
pepselect_shipping_assert( ! PepSelect_Shipping_Restrictions::address_is_allowed( 'US', 'PR', '00901' ), 'Puerto Rico must be selected as the country.' );
pepselect_shipping_assert( ! PepSelect_Shipping_Restrictions::address_is_allowed( 'PR', '', '10001' ), 'New York ZIP with Puerto Rico country selected should fail.' );
...
pepselect_shipping_assert(
	array( 'easyship:usps' ) === array_keys(
		$restriction->filter_package_rates(
			$rates,
			array( 'destination' => array( 'country' => 'PR', 'state' => '', 'postcode' => '00901' ) )
		)
	),

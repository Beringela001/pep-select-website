...
assert.match(plugin, /DELAY_DAYS_OPTION/);
assert.match(plugin, /min="1" max="60"/);
assert.match(plugin, /Save timing/);
assert.match(plugin, /reschedule_pending_invitations/);

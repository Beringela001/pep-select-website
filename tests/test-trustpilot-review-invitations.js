...
assert.match(plugin, /is_email_excluded/);
assert.match(plugin, /pepselect-customer-emails/);
assert.match(plugin, /wc_get_customers/);
assert.match(plugin, /get_users/);
assert.match(plugin, /Order billing email/);
assert.match(plugin, /Test block/);
assert.match(plugin, /A successful test never sends an email/);

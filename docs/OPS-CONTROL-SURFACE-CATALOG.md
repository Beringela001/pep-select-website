...
| Pep Select Cart Recovery | 0.4.6 | READY | Authenticated popup-settings REST endpoint | Add revision conflicts and stronger audit metadata |
...
## 2. Pep Select Cart Recovery 0.4.6 — READY WITH CONTRACT GAP

...
**Release status:** Owner-approved and deployed to Live on August 19, 2026 as child theme `0.25.0-beta.34` and COA Archive `0.7.3`. The guide is published at `https://pepselect.com/guides/how-to-review-research-peptide-documentation/`, and its discovery card is live directly below the Quality Archive hero. The guide includes six real Pep Select and laboratory-document examples with eighteen numbered callouts covering batch identity, vial photographs, cap and crimp, external laboratory verification, a corrected-strength record, and rejected batches. The Freedom Diagnostics example displays as a complete image without an internal scrolling frame, and the `Reported` definition states only that the record presents a laboratory value. The public page now emits one Yoast description tag while preserving its visible excerpt. Evidence: [`SEO-M4-BATCH-2-EVIDENCE-REGISTER-2026-08-19.md`](SEO-M4-BATCH-2-EVIDENCE-REGISTER-2026-08-19.md). Visual revision: [`SEO-M4-BATCH-2-VISUAL-EVIDENCE-REVISION-2026-08-19.md`](SEO-M4-BATCH-2-VISUAL-EVIDENCE-REVISION-2026-08-19.md). Staging release: [`claude-seo-latest/STAGING-SEO-M4-BATCH-2-RELEASE-2026-08-19.md`](claude-seo-latest/STAGING-SEO-M4-BATCH-2-RELEASE-2026-08-19.md). Live release: [`claude-seo-latest/LIVE-SEO-M4-BATCH-2-RELEASE-2026-08-19.md`](claude-seo-latest/LIVE-SEO-M4-BATCH-2-RELEASE-2026-08-19.md).

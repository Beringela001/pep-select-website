...
**Release status:** Implemented and verified on Staging on August 19, 2026 as child theme `0.25.0-beta.32`. Paulo approved the original guide and selected a discovery card directly below the Quality Archive hero. The guide now includes six real Pep Select and laboratory-document examples with eighteen numbered callouts covering batch identity, vial photographs, cap and crimp, external laboratory verification, a corrected-strength record, and rejected batches. The Freedom Diagnostics example displays as a complete image without an internal scrolling frame, and the `Reported` definition states only that the record presents a laboratory value. The discovery card remains deployed to Staging in COA Archive `0.7.3`. The complete visual revision awaits Paulo's final review before Batch 2 moves to Live. Live remains unchanged. Evidence: [`SEO-M4-BATCH-2-EVIDENCE-REGISTER-2026-08-19.md`](SEO-M4-BATCH-2-EVIDENCE-REGISTER-2026-08-19.md). Visual revision: [`SEO-M4-BATCH-2-VISUAL-EVIDENCE-REVISION-2026-08-19.md`](SEO-M4-BATCH-2-VISUAL-EVIDENCE-REVISION-2026-08-19.md). Staging release: [`claude-seo-latest/STAGING-SEO-M4-BATCH-2-RELEASE-2026-08-19.md`](claude-seo-latest/STAGING-SEO-M4-BATCH-2-RELEASE-2026-08-19.md).

...
### 2. Prioritize welcome, checkout recovery, and post-purchase
...
### 3. Make checkout recovery a trust and decision-support flow
...
### 4. Split customers by behavior and eligibility

First-time customers, returning customers, high-value customers, dormant customers, and active subscribers need different messages. Segmentation must use documented criteria and honor unsubscribe, recovery suppression, and consent status across systems.

### 5. Protect list portability and deliverability
...
### 6. Moderate customer-supplied content
...
| High-value customer | Recognize customers with validated high lifetime value | Use a documented segment; re-evaluate membership; never imply false exclusivity | Faster support paths, relevant documentation updates, optional early notice where operationally true | Build after segment validation |
...
- Preserve the currently approved private-offer and recovery economics until margin and incrementality data justify a change.
- Never invent a deadline, stock condition, limited quantity, or last chance.
- Test help, documentation access, and objection resolution before adding a larger discount.
...
4. Build first-time and returning-customer post-purchase paths without duplicating transactional email.
5. Validate high-value and dormant-customer segments, then pilot recognition and winback flows.
6. Review privacy, tracking, and consent requirements before browse follow-up.
7. Analyze real reorder intervals and approve research-framed copy before any reorder-consideration pilot.
8. Add an encrypted, tested list-export and recovery procedure with privacy controls.
...
| Top 5–10% VIP segment | Test | Validate the cutoff from Pep Select lifetime-value distribution |

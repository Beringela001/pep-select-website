...
| M2 — Mobile performance | Evidence images, homepage hero, unused/render-blocking assets, four-template PageSpeed | Implemented and deployed on Live. The August 19 mobile rerun records scores of 79–84, LCP of 3.6–4.4 seconds, TBT of 0–120 ms, and CLS of 0–0.084. The quota blocker is closed; remaining LCP and render-blocking work stays open. | Post-release measurement completed on 2026-08-19. No field-data improvement is claimed because Google reports insufficient 90-day usage data. |
| M3 — Indexation and schema | Crawl paths, pagination, GSC inspection, connected Product/Offer/Organization/Dataset schema | Deployed and verified on Live. GSC confirms NAD+ is indexed; Shop and Quality Archive are discovered but not indexed; the guide and Retatrutide 10 mg were unknown to Google. | Google accepted indexing/recrawl requests for all five inspected URLs on 2026-08-19. Reinspection after crawl processing remains the outcome gate. |
| M4 — Evidence-led content and GEO | Product copy, trust/evidence hubs, compliant query coverage | Batches 1–4 are deployed on Live. Batch 2 supplied the evidence guide; Batches 3–4 preserved simple product copy and added the dynamic compact COA card near the purchase decision. | Live releases passed backup, cache, desktop/mobile, commerce, and COA-state checks. Search Console requests were submitted on 2026-08-19; indexing and traffic remain measurement outcomes. |
